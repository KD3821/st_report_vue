  ...
  <div class="col-md-5 mx-auto">
    <div class="text-center">
      <form class="form-signin" @submit.prevent="userRegister">
        ...
        <label for="reInputPassword" class="sr-only">Пароль еще раз</label>
        <input type="password" id="reInputPassword" class="form-control mt-2" placeholder="Пароль" required="" v-model="register.password2">
        <button class="btn mt-2 btn-lg btn-primary btn-block" type="submit">Зарегистрировать</button>
      </form>
    </div>
  </div>
</template>
